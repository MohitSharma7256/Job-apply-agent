    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="pt-6 border-t border-white/5 space-y-4">
          <Link href="/dashboard/settings" onClick={() => setIsOpen(false)} className="flex items-center gap-3 p-3 rounded-2xl text-slate-400 hover:bg-white/5 hover:text-white transition-all w-full text-left">

...
exports.referralHunter = exports.ReferralHunter = void 0;
const openai_1 = __importDefault(require("openai"));
const openai = new openai_1.default({
    apiKey: process.env.OPENAI_API_KEY,
});
class ReferralHunter {
    async huntAndConnect(page, job, profile) {
    ...
    async generateReferralMessage(profile, job) {
        const prompt = `
...
exports.ReferralHunter = ReferralHunter;
exports.referralHunter = new ReferralHunter();
